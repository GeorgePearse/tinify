...
:mod:`~tinify.entropy_models.EntropyBottleneck` module, 3 convolutions at
the encoder, 3 transposed deconvolutions for the decoder, and
:mod:`~tinify.layers.GDN` activation functions:
...
CompressAI provides a :mod:`~tinify.models.CompressionModel` base class,
that includes an :mod:`~tinify.entropy_models.EntropyBottleneck` module
