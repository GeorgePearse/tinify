...
.. currentmodule:: tinify.latent_codecs


A :py:class:`~LatentCodec` is an abstraction for compressing a latent space using some entropy modeling technique.
A :py:class:`~LatentCodec` can be thought of as a miniature :py:class:`~tinify.models.base.CompressionModel`.
...
.. list-table::
   ...
   * - :py:class:`~EntropyBottleneckLatentCodec`
     - Uses an :py:class:`~tinify.entropy_models.EntropyBottleneck` to encode ``y``.
   * - :py:class:`~GaussianConditionalLatentCodec`
     - Uses a :py:class:`~tinify.entropy_models.GaussianConditional` to encode ``y`` using ``(scale, mean)`` parameters.
   * - :py:class:`~HyperLatentCodec`
     - Uses an :py:class:`~tinify.entropy_models.EntropyBottleneck` to encode ``z``, with surrounding ``h_a`` and ``h_s`` transforms.
...
.. code-block:: python
    ...
    from tinify.models.base import SimpleVAECompressionModel

Using :py:class:`~tinify.models.base.SimpleVAECompressionModel`, some Google-style VAE models may be implemented as follows:
...
Like :py:class:`~tinify.models.base.CompressionModel`, a subclass of :py:class:`~LatentCodec` should implement:
